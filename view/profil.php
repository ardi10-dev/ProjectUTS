...
if(!isset($_SESSION['access_token'])){
    $login_button = '<a href="'.$google_client->createAuthUrl().'"><img src="login.png" alt=""></a>';
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white">
    ...
    <a class="navbar-brand" href="#"
      style="color: dodgerblue;font-family: 'Pacifico', cursive;">PULSA MURAH OFFICIAL</a>
...
<?php
if($login_button == ''){
    echo '<div class="panel-haeding">Berikut adalah biaodata anda </div><div
    class="panel-body>';
